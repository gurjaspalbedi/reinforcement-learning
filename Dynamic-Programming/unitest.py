...
test.assertEqual(actions[1], ['D', 'L', 'R'])
test.assertEqual(actions[2], ['D', 'L', 'R'])
test.assertEqual(actions[3], [])
test.assertEqual(actions[4], ['U','D', 'R'])
test.assertEqual(actions[5], ['U','D', 'L','R'])
test.assertEqual(actions[6], ['U','D', 'L', 'R'])
test.assertEqual(actions[7], [])
test.assertEqual(actions[8], ['U', 'R'])
test.assertEqual(actions[9], ['U','L', 'R'])
